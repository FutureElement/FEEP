...
<script src="${contextPath}/Resource/thirdLib/bootstrap-check/js/icheck.min.js"></script>
<script src="${contextPath}/Resource/thirdLib/jquery-pin/jquery.pin.js"></script>
<script src="${contextPath}/Resource/ui/js/fui.js"></script>
