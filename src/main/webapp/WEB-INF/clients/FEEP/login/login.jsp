                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="loginModalLabel">
                                    <strong>用户登陆</strong> <span id="login_message"
                                                                class="text-danger login-message pull-right"></span>
                                </h4>
                            </div>
                            ...
                            <div class="modal-footer" style="padding-top: 0;">
                                <div class="checkbox">
                                    <label style="float: left; padding-left: 0px;"> <input id="isSaveUsername"
                                                                                           type="checkbox"
                                                                                           data-size="mini"
                                                                                           data-label-width="20"
                                                                                           data-on-text="记住用户名"
                                                                                           data-off-text="不记住用户名">
                                    </label> <a style="float: right; cursor: pointer; padding-top: 2px;"
                                                onclick="forgotPassword();">忘记密码？</a>
                                </div>
                            </div>
                        </div>
                    </div>
