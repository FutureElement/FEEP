      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <small style="color: #FFFFFF;width:100%;">只需专注业务，其他的交给平台来处理吧！</small>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#">版本管理</a></li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">报表中心 <span class="caret"></span></a>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle " data-toggle="dropdown" role="button" aria-expanded="false">开发手册<span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="#">服务端</a></li>
                <li class="divider"></li>
                <li><a href="#">客户端</a></li>
    ...
    <div class="container-fluid" id="indexContent" style="background-color: #CCCCCC;margin-top: -20px;height: 1000px;">
      <div class="row">
        <div class="col-md-3" style="padding-top: 20px;" data-spy="scroll" data-target="#indexMenu">
          <nav class="affix-top" data-spy="affix" data-offset-top="220" id="indexMenu" data-offset-bottom="20" style="top: 70px;width: 200px;">
            <ul class="list-group">
